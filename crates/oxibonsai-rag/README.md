...
[![Version](https://img.shields.io/badge/version-0.2.3-blue)](https://crates.io/crates/oxibonsai-rag)
...
**Stable** — version 0.2.3, 871 tests passing (`cargo nextest run -p oxibonsai-rag`). Uplifted from Alpha in 0.1.2.

...
[![Version](https://img.shields.io/badge/version-0.1.4-blue)](https://crates.io/crates/oxibonsai-rag)
...
**Stable** — version 0.1.4, 206 tests passing (`cargo nextest run -p oxibonsai-rag`). Uplifted from Alpha in 0.1.2.
